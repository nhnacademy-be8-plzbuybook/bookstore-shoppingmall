...
class WrappingPaperServiceImplTest {
    ...
    void createWrappingPaper() {
        //given
        WrappingPaperSaveRequestDto saveRequest = new WrappingPaperSaveRequestDto("name", new BigDecimal("3000"), 100L);
        ...
        //when
        WrappingPaperSaveResponseDto saveResponse = service.createWrappingPaper(saveRequest, mockMultipartFile);
