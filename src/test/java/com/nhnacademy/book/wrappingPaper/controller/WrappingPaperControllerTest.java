...
//        verify(wrappingPaperService).createWrappingPaper(any(WrappingCreateSaveRequestDto.class), any(MultipartFile.class));
//    }
//
//    @Test
//    void createWrappingPaper_invalid_argument() throws Exception {
//        //given
//        WrappingCreateSaveRequestDto saveRequest = new WrappingCreateSaveRequestDto(" ", new BigDecimal("1000"), 100L);
//        WrappingPaperCreateResponseDto saveResponse = new WrappingPaperCreateResponseDto(1L);
//
//        when(wrappingPaperService.createWrappingPaper(any(WrappingCreateSaveRequestDto.class), any(MultipartFile.class))).thenReturn(saveResponse);
//        MockMultipartFile imageFile = new MockMultipartFile(
