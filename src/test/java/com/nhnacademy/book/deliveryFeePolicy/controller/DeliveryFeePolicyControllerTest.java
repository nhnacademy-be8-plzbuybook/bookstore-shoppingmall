...
class DeliveryFeePolicyControllerTest {
    ...
    @DisplayName("배송비정책 조회")
    @Test
    void getPolicy() throws Exception {
        //given
        long id = 1L;
        String url = BASE_URL + "/" + id;
        DeliveryFeePolicyDto existingPolicy = new DeliveryFeePolicyDto(id, "policyName", new BigDecimal("3000"), new BigDecimal("30000"));
    ...
    @DisplayName("배송비정책 생성")
    @Test
    void createPolicy() throws Exception {
        //given
        BigDecimal defaultFee = new BigDecimal("3000");
        BigDecimal freeThreshold = new BigDecimal("30000");
        DeliveryFeePolicySaveRequestDto saveRequest = new DeliveryFeePolicySaveRequestDto("policyName", defaultFee, freeThreshold);
        long id = 1L;
    ...
    void modifyPolicy() throws Exception {
        ...
        DeliveryFeePolicyUpdateRequestDto updateRequest = new DeliveryFeePolicyUpdateRequestDto("policyName", new BigDecimal("4000"), new BigDecimal("40000"));
